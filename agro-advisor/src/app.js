...
function TopNav() {
  let tabs = [{"id": "advisor", "label": "Advisor", "path": "/"}, {"id": "admin", "label": "Manage", "path": "/admin"}, {"id": "debug", "label": "Monitor", "path": "/debug"}];
  let isLoggedIn = jacIsLoggedIn();
  let navigate = useNavigate();
