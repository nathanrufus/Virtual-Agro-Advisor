...
function AdvisorForm(props) {
  ...
  }, "className": "w-full min-h-[120px] rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-green-500 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600 resize-y"}, [])]), __jacJsx("div", {"className": "space-y-2 pt-1"}, [__jacJsx("label", {"className": "text-sm font-medium text-slate-800"}, ["Select Language"]), __jacJsx("div", {"className": "flex gap-2"}, [__jacJsx("label", {"className": "flex-1"}, [__jacJsx("input", {"type": "radio", "name": "advisor-language", "value": "en", "checked": props.language === "en", "onChange": e => {
...
function DebugPage() {
  ...
  return __jacJsx("div", {"className": "space-y-6"}, [__jacJsx("div", {}, [__jacJsx("h1", {"className": "text-xl font-semibold text-slate-900"}, ["Debug tools"]), __jacJsx("p", {"className": "mt-1 text-xs text-slate-500"}, ["Run the LLM analysis and advice walkers directly with test inputs."])]), error && __jacJsx("div", {"className": "rounded-2xl border border-red-200 bg-red-50 p-4 text-sm text-red-700"}, [error]), __jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4 text-sm text-slate-700 space-y-4"}, [__jacJsx("div", {"className": "grid gap-3 sm:grid-cols-2"}, [__jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": " text-[11px]  sm:text-xs  md:text-sm  lg:text-base  font-medium  text-slate-700"}, ["Crop"]), __jacJsx("input", {"className": "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500", "value": crop, "onChange": e => {
    setCrop(e.target.value);
  }, "placeholder": "maize"}, [])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": " text-[11px]  sm:text-xs  md:text-sm  lg:text-base  font-medium  text-slate-700"}, ["Location"]), __jacJsx("input", {"className": "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500", "value": location, "onChange": e => {
    setLocation(e.target.value);
  }, "placeholder": "Kiambu, Kenya"}, [])])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": " text-[11px]  sm:text-xs  md:text-sm  lg:text-base  font-medium  text-slate-700"}, ["Problem description"]), __jacJsx("textarea", {"className": "h-28 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500", "value": problemText, "onChange": e => {
...
function TopNav() {
  ...
  return __jacJsx("header", {"className": "border-b border-slate-200 bg-white/80 backdrop-blur"}, [__jacJsx("div", {"className": "flex w-full items-center justify-between px-4 lg:px-10 py-3"}, [__jacJsx("div", {"className": "flex items-center gap-2"}, [__jacJsx("div", {"className": "flex h-8 w-8 items-center justify-center rounded-xl bg-lime-500"}, [__jacJsx("span", {"className": "h-4 w-4 rounded-md bg-white/80"}, [])]), __jacJsx("span", {"className": "text-sm font-semibold text-slate-900"}, ["Virtual Agro-Advisor"])]), __jacJsx("nav", {"className": "flex items-center gap-3 text-sm"}, [isLoggedIn && tabs.map(tab => {
