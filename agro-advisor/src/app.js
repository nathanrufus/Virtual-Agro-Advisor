...
function AdvisorForm(props) {
  ...
  return __jacJsx("form", {"onSubmit": handleSubmit, "className": "flex h-full min-h-[520px] flex-col rounded-2xl border border-lime-100 bg-white p-6 shadow-sm"}, [__jacJsx("div", {"className": "space-y-1"}, [__jacJsx("h1", {"className": "text-2xl font-semibold text-slate-900"}, ["Get Personalized Agricultural Advice"]), __jacJsx("p", {"className": "text-slate-500"}, ["Fill in the details below to receive a tailored plan for your crops."])]), __jacJsx("div", {"className": "mt-4 flex-1 space-y-4 overflow-y-auto pr-1"}, [__jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-800"}, ["Give Crop"]), __jacJsx("input", {"type": "text", "placeholder": "e.g., Maize, Wheat, Soybeans", "value": props.crop, "onChange": e => {
    props.onCropChange(e.target.value);
  }, "className": "w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-lime-500/70 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600"}, [])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-800"}, ["Enter Location"]), __jacJsx("input", {"type": "text", "placeholder": "e.g., Kisumu, Kenya", "value": props.location, "onChange": e => {
    props.onLocationChange(e.target.value);
  }, "className": "w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-lime-500/70 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600"}, [])]), __jacJsx("div", {"className": "space-y-2"}, [__jacJsx("label", {"className": "font-medium text-slate-800"}, ["Upload Image (optional)"]), __jacJsx("input", {"type": "file", "accept": "image/*", "onChange": handleImageChange, "className": "block w-full text-slate-700 file:mr-4 file:rounded-full file:border-0 file:bg-green-50 file:px-4 file:py-2 file:file:font-semibold file:text-green-700 hover:file:bg-green-100"}, []), props.imagePreviewUrl && props.imagePreviewUrl !== "" ? __jacJsx("div", {"className": "mt-2 overflow-hidden rounded-xl border border-slate-200 bg-slate-50"}, [__jacJsx("img", {"src": props.imagePreviewUrl, "alt": "Problem preview", "className": "h-40 w-full object-cover"}, [])]) : __jacJsx("div", {"className": "mt-2 flex h-24 items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 text-slate-400"}, ["No image selected – you can upload a clear photo of the affected plant."])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-800"}, ["Describe Your Problem"]), __jacJsx("textarea", {"rows": 4, "placeholder": "Describe the issue you are facing in detail...", "value": props.problemText, "onChange": e => {
    props.onProblemTextChange(e.target.value);
  }, "className": "w-full min-h-[120px] rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-green-500 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600 resize-y"}, [])]), __jacJsx("div", {"className": "space-y-2 pt-1"}, [__jacJsx("label", {"className": "font-medium text-slate-800"}, ["Select Language"]), __jacJsx("div", {"className": "flex gap-2"}, [__jacJsx("label", {"className": "flex-1"}, [__jacJsx("input", {"type": "radio", "name": "advisor-language", "value": "en", "checked": props.language === "en", "onChange": e => {
    props.onLanguageChange("en");
  }, "className": "peer sr-only"}, []), __jacJsx("div", {"className": "w-full rounded-md border border-green-600 bg-white px-4 py-2 font-semibold text-green-700 transition peer-checked:bg-green-600 peer-checked:text-white"}, ["EN - English"])]), __jacJsx("label", {"className": "flex-1"}, [__jacJsx("input", {"type": "radio", "name": "advisor-language", "value": "sw", "checked": props.language === "sw", "onChange": e => {
    props.onLanguageChange("sw");
  }, "className": "peer sr-only"}, []), __jacJsx("div", {"className": " w-full rounded-md border border-green-600 bg-white px-4 py-2 font-semibold text-green-700 transition peer-checked:bg-green-600 peer-checked:text-white"}, ["SW - Swahili"])])])]), __jacJsx("div", {"className": "border-t border-slate-200 pt-3"}, []), __jacJsx("div", {"className": "space-y-3 text-slate-800"}, [__jacJsx("label", {"className": "flex items-center gap-3"}, [__jacJsx("span", {"className": "relative inline-flex h-6 w-11 items-center"}, [__jacJsx("input", {"type": "checkbox", "checked": props.includeWeather, "onChange": e => {
...
function AdminPage() {
  ...
  return __jacJsx("div", {"className": "space-y-6"}, [__jacJsx("div", {"className": "flex flex-wrap items-center justify-between gap-3"}, [__jacJsx("div", {}, [__jacJsx("h1", {"className": "text-xl font-semibold text-slate-900"}, ["Admin dashboard"]), __jacJsx("p", {"className": "mt-1 text-slate-500"}, ["Inspect sessions and advice cache, and run maintenance tasks."])]), __jacJsx("div", {"className": "flex flex-wrap gap-2"}, [__jacJsx("button", {"className": "rounded-lg border border-slate-300 px-3 py-1 font-medium hover:bg-slate-50 disabled:opacity-60", "disabled": loading, "onClick": e => {
    loadAdminData();
  }}, [loading ? "Refreshing\u2026" : "Refresh"]), __jacJsx("button", {"className": "rounded-lg border border-amber-300 bg-amber-50 px-3 py-1 font-medium text-amber-900 hover:bg-amber-100 disabled:opacity-60", "disabled": cleaningSessions, "onClick": e => {
    handleCleanupSessions();
  }}, [cleaningSessions ? "Cleaning sessions\u2026" : "Cleanup old sessions"]), __jacJsx("button", {"className": "rounded-lg border border-rose-300 bg-rose-50 px-3 py-1 font-medium text-rose-900 hover:bg-rose-100 disabled:opacity-60", "disabled": clearingCache, "onClick": e => {
    handleClearCache();
  }}, [clearingCache ? "clear advice cache" : "clear advice cache"])])]), flash && __jacJsx("div", {"className": "rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-2 text-emerald-800"}, [flash]), error && __jacJsx("div", {"className": "rounded-2xl border border-red-200 bg-red-50 px-4 py-2 text-red-700"}, [error]), __jacJsx("div", {"className": "grid gap-4 md:grid-cols-3"}, [__jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4"}, [__jacJsx("p", {"className": "text-slate-500"}, ["Total sessions"]), __jacJsx("p", {"className": "mt-1 text-xl font-semibold text-slate-900"}, [stats["totalSessions"]])]), __jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4"}, [__jacJsx("p", {"className": "text-slate-500"}, ["Advice cache entries"]), __jacJsx("p", {"className": "mt-1 text-xl font-semibold text-slate-900"}, [stats["adviceEntries"]])]), __jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4"}, [__jacJsx("p", {"className": "text-slate-500"}, ["Latest session activity"]), __jacJsx("p", {"className": "mt-1 font-medium text-slate-900"}, [stats["latestSessionTime"] ? formatShortDatetime(stats["latestSessionTime"]) : "_"])])]), __jacJsx("div", {"className": "grid gap-4 lg:grid-cols-2"}, [__jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4 text-slate-700"}, [__jacJsx("div", {"className": "mb-3 flex items-center justify-between"}, [__jacJsx("h2", {"className": "font-semibold text-slate-800"}, ["Sessions"]), __jacJsx("span", {"className": "text-[10px] uppercase tracking-wide text-slate-400"}, ["GetAllSessions"])]), sessionRows && sessionRows.length > 0 ? __jacJsx("div", {"className": "overflow-x-auto"}, [__jacJsx("table", {"className": "min-w-full text-left "}, [__jacJsx("thead", {"className": "border-b border-slate-100 text-[10px] uppercase tracking-wide text-slate-400"}, [__jacJsx("tr", {}, [__jacJsx("th", {"className": "py-1 pr-3"}, ["Session ID"]), __jacJsx("th", {"className": "py-1 pr-3"}, ["Lang"]), __jacJsx("th", {"className": "py-1 pr-3"}, ["Created"]), __jacJsx("th", {"className": "py-1"}, ["Last active"])])]), __jacJsx("tbody", {"className": ""}, [sessionRows.map((sess, idx) => {
  ...
  })])]), sessionRows.length > 10 && __jacJsx("p", {"className": "mt-2 text-[10px] text-slate-400"}, ["Showing first 10 sessions."])]) : __jacJsx("p", {"className": "text-slate-500"}, ["No sessions yet."])]), __jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4 text-slate-700"}, [__jacJsx("div", {"className": "mb-3 flex items-center justify-between"}, [__jacJsx("h2", {"className": "font-semibold text-slate-800"}, ["Advice cache"]), __jacJsx("span", {"className": "text-[10px] uppercase tracking-wide text-slate-400"}, ["GetAllAdviceCache"])]), adviceRows && adviceRows.length > 0 ? __jacJsx("div", {"className": "overflow-x-auto"}, [__jacJsx("table", {"className": "min-w-full text-left "}, [__jacJsx("thead", {"className": "border-b border-slate-100 text-[10px] uppercase tracking-wide text-slate-400"}, [__jacJsx("tr", {}, [__jacJsx("th", {"className": "py-1 pr-3"}, ["Crop"]), __jacJsx("th", {"className": "py-1 pr-3"}, ["Region"]), __jacJsx("th", {"className": "py-1 pr-3"}, ["Usage"]), __jacJsx("th", {"className": "py-1"}, ["Last used"])])]), __jacJsx("tbody", {"className": ""}, [adviceRows.map((entry, idx) => {
    ...
    }}, [__jacJsx("td", {"className": "py-1 pr-3"}, [meta["crop"] || "\u2014"]), __jacJsx("td", {"className": "py-1 pr-3"}, [meta["region"] || "\u2014"]), __jacJsx("td", {"className": "py-1 pr-3"}, [entry["usage_count"] || 0]), __jacJsx("td", {"className": "py-1"}, [formatShortDatetime(entry["last_used_at"] || "")])]);
  })])]), adviceRows.length > 10 && __jacJsx("p", {"className": "mt-2 text-[10px] text-slate-400"}, ["Showing first 10 advice cache entries."])]) : __jacJsx("p", {"className": "text-slate-500"}, ["No advice cache entries yet."])])])]);
}
function LoginPage() {
  ...
  }, "placeholder": "••••••••", "className": "w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-slate-400 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600"}, [])]), __jacJsx("button", {"type": "submit", "disabled": loading, "className": "mt-2 inline-flex w-full items-center justify-center rounded-full bg-green-500 px-4 py-2.5 font-semibold text-white shadow-md hover:bg-emerald-800 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-1"}, [buttonLabel])]), __jacJsx("p", {"className": "mt-4 text-center text-slate-500"}, ["Need an account?", " ", __jacJsx(Link, {"to": "/signup", "className": "font-semibold text-emerald-700 hover:text-emerald-900"}, ["Sign up"])])])]);
}
function SignupPage() {
  let [email, setEmail] = useState("");
  let [password, setPassword] = useState("");
  ...
  return __jacJsx("div", {"className": " bg-[#F3F7F2] flex items-center justify-center px-4 mt-20"}, [__jacJsx("div", {"className": "w-full max-w-md rounded-2xl border border-lime-100 bg-white p-6 shadow-sm"}, [__jacJsx("h1", {"className": "text-2xl font-semibold text-slate-900"}, ["Create your account"]), error && __jacJsx("div", {"className": "mt-4 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-red-700"}, [error]), __jacJsx("form", {"onSubmit": handleSignup, "className": "mt-4 space-y-4"}, [__jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-700"}, ["Email"]), __jacJsx("input", {"type": "email", "value": email, "onChange": e => {
    ...
    setPassword(e.target.value);
  }, "placeholder": "Choose a strong password", "className": "w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-slate-400 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600"}, [])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-700"}, ["Confirm password"]), __jacJsx("input", {"type": "password", "value": confirmPassword, "onChange": e => {
    setConfirmPassword(e.target.value);
  }, "placeholder": "Repeat your password", "className": "w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 outline-none placeholder:text-slate-400 focus:border-emerald-600 focus:bg-white focus:ring-1 focus:ring-emerald-600"}, [])]), __jacJsx("button", {"type": "submit", "disabled": loading, "className": "mt-2 inline-flex w-full items-center justify-center rounded-full bg-green-500 px-4 py-2.5 font-semibold text-white shadow-md hover:bg-emerald-800 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-1"}, [buttonLabel])]), __jacJsx("p", {"className": "mt-4 text-center text-slate-500"}, ["Already have an account?", " ", __jacJsx(Link, {"to": "/login", "className": "font-semibold text-emerald-700 hover:text-emerald-900"}, ["Log in"])])])]);
}
...
function DebugPage() {
  ...
  let severityClass = "inline-flex items-center rounded-full border border-slate-200 bg-slate-50 px-2 py-0.5 font-medium text-slate-700";
  if (severity === "low") {
  ...
  return __jacJsx("div", {"className": "space-y-6"}, [__jacJsx("div", {}, [__jacJsx("h1", {"className": "text-xl font-semibold text-slate-900"}, ["Debug tools"]), __jacJsx("p", {"className": "mt-1 text-slate-500"}, ["Run the LLM analysis and advice walkers directly with test inputs."])]), error && __jacJsx("div", {"className": "rounded-2xl border border-red-200 bg-red-50 p-4 text-red-700"}, [error]), __jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4 text-slate-700 space-y-4"}, [__jacJsx("div", {"className": "grid gap-3 sm:grid-cols-2"}, [__jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": " font-medium text-slate-700"}, ["Crop"]), __jacJsx("input", {"className": "w-full rounded-lg border border-slate-200 px-3 py-2 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500", "value": crop, "onChange": e => {
    setCrop(e.target.value);
  }, "placeholder": "maize"}, [])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-700"}, ["Location"]), __jacJsx("input", {"className": "w-full rounded-lg border border-slate-200 px-3 py-2 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500", "value": location, "onChange": e => {
    setLocation(e.target.value);
  }, "placeholder": "Kiambu, Kenya"}, [])])]), __jacJsx("div", {"className": "space-y-1"}, [__jacJsx("label", {"className": "font-medium text-slate-700"}, ["Problem description"]), __jacJsx("textarea", {"className": "h-28 w-full rounded-lg border border-slate-200 px-3 py-2 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500", "value": problemText, "onChange": e => {
    setProblemText(e.target.value);
  }, "placeholder": "Describe the farmer&#39;s issue here (e.g. leaves are curling and turning yellow)…", "required": true}, [])]), __jacJsx("div", {"className": "flex flex-wrap gap-2"}, [__jacJsx("button", {"className": "rounded-lg border border-slate-300 px-3 py-1.5 font-medium hover:bg-slate-50 disabled:opacity-60", "disabled": loadingAnalysis, "onClick": e => {
    runAnalyzeDebug();
  }}, [loadingAnalysis ? "Running LLMAnalyzeDebug\u2026" : "Run LLMAnalyzeDebug"]), __jacJsx("button", {"className": "rounded-lg bg-emerald-600 px-3 py-1.5 font-medium text-white hover:bg-emerald-700 disabled:opacity-60", "disabled": loadingAdvice, "onClick": e => {
    runAdviceDebug();
  }}, [loadingAdvice ? "Running LLMAdviceDebug\u2026" : "Run LLMAdviceDebug"])])]), __jacJsx("div", {"className": "grid gap-4 lg:grid-cols-2"}, [__jacJsx("div", {"className": "flex h-[320px] flex-col rounded-2xl border border-slate-200 bg-white p-4 text-slate-700"}, [__jacJsx("div", {"className": "mb-2 flex items-center justify-between"}, [__jacJsx("h2", {"className": "font-semibold text-slate-800"}, ["IssueAnalysis"]), __jacJsx("span", {"className": "uppercase tracking-wide text-slate-400"}, ["LLMAnalyzeDebug"])]), __jacJsx("div", {"className": "mt-1 flex-1 overflow-y-auto"}, [analysis ? __jacJsx("div", {"className": "space-y-3"}, [__jacJsx("div", {"className": "flex flex-wrap items-center gap-2"}, [__jacJsx("span", {"className": " uppercase tracking-wide text-slate-400"}, ["Problem type"]), __jacJsx("span", {"className": "inline-flex items-center rounded-full bg-slate-50 px-2 py-0.5  font-medium text-slate-800"}, [problemType || "\u2014"]), __jacJsx("span", {"className": "ml-3  uppercase tracking-wide text-slate-400"}, ["Severity"]), __jacJsx("span", {"className": severityClass}, [severity || "\u2014"])]), __jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1 font-medium text-slate-500"}, ["Key symptoms"]), "key_symptoms" in analysis && analysis["key_symptoms"] && analysis["key_symptoms"].length > 0 ? __jacJsx("ul", {"className": "list-disc space-y-1 pl-5 "}, [analysis["key_symptoms"].map((s, idx) => {
    return __jacJsx("li", {"key": idx}, [s]);
  })]) : __jacJsx("p", {"className": "text-slate-400"}, ["No key symptoms returned."])])]) : __jacJsx("p", {"className": "text-slate-500"}, ["Run LLMAnalyzeDebug to see structured IssueAnalysis here."])])]), __jacJsx("div", {"className": "flex h-[320px] flex-col rounded-2xl border border-slate-200 bg-white p-4 text-slate-700"}, [__jacJsx("div", {"className": "mb-2 flex items-center justify-between"}, [__jacJsx("h2", {"className": "font-semibold text-slate-800"}, ["AdvicePlan"]), __jacJsx("span", {"className": " uppercase tracking-wide text-slate-400"}, ["LLMAdviceDebug"])]), __jacJsx("div", {"className": "mt-1 flex-1 overflow-y-auto"}, [advice ? __jacJsx("div", {"className": "space-y-4"}, [__jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1  font-medium text-slate-500"}, ["Overview"]), __jacJsx("p", {"className": "leading-relaxed text-slate-700"}, [advice["overview"] || "No overview returned."])]), __jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1  font-medium text-slate-500"}, ["Recommended steps"]), "steps" in advice && advice["steps"] && advice["steps"].length > 0 ? __jacJsx("ol", {"className": " space-y-2 pl-5"}, [advice["steps"].map((step, idx) => {
    return __jacJsx("li", {"key": idx, "className": "text-slate-700"}, [step]);
  })]) : __jacJsx("p", {"className": "text-slate-400"}, ["No steps returned."])]), __jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1 font-medium text-slate-500"}, ["Cautions"]), "cautions" in advice && advice["cautions"] && advice["cautions"].length > 0 ? __jacJsx("ul", {"className": "list-disc space-y-1 pl-5  text-slate-700"}, [advice["cautions"].map((c, idx) => {
    return __jacJsx("li", {"key": idx}, [c]);
  })]) : __jacJsx("p", {"className": "text-slate-400"}, ["No cautions returned."])])]) : __jacJsx("p", {"className": " text-slate-500"}, ["Run LLMAdviceDebug to see the generated AdvicePlan here."])])])])]);
}
function AdvicePlanPanel(props) {
  ...
  return __jacJsx("div", {"className": "flex h-[520px] flex-col rounded-2xl border border-lime-100 bg-white p-5 md:p-6 shadow-sm"}, [__jacJsx("div", {"className": "mb-2 flex items-center justify-between gap-2"}, [__jacJsx("h2", {"className": "text-base font-semibold text-slate-900"}, ["Advice Plan"]), sourceLabel && __jacJsx("span", {"className": "inline-flex items-center gap-1 rounded-full px-3 py-1 font-medium " + sourceColor}, [__jacJsx("span", {"className": "h-1.5 w-1.5 rounded-full bg-current"}, []), sourceLabel])]), __jacJsx("div", {"className": "mt-1 flex-1 overflow-y-auto rounded-xl bg-slate-50/70 px-3 py-2"}, [props.error && __jacJsx("p", {"className": "text-red-600"}, [props.error]), !props.error && props.loading && __jacJsx("p", {"className": "text-slate-500"}, ["Generating advice…"]), !props.error && !props.loading && !props.advicePlan && __jacJsx("p", {"className": "text-slate-500"}, ["Fill in the form on the left and click", " ", __jacJsx("span", {"className": "font-semibold"}, ["Get Advice"]), " to see your plan here."]), !props.error && !props.loading && props.advicePlan && __jacJsx("div", {"className": "space-y-3 text-slate-800"}, [__jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1 font-semibold"}, [overviewTitle]), __jacJsx("p", {"className": "leading-relaxed"}, [props.advicePlan.overview])]), props.advicePlan.steps && props.advicePlan.steps.length > 0 && __jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1 font-semibold"}, [stepsTitle]), __jacJsx("ol", {"className": " space-y-1 pl-5"}, [props.advicePlan.steps.map((step, idx) => {
    return __jacJsx("li", {"key": idx}, [step]);
  })])]), props.advicePlan.cautions && props.advicePlan.cautions.length > 0 && __jacJsx("div", {"className": "rounded-xl border border-amber-100 bg-amber-50 p-3"}, [__jacJsx("p", {"className": "mb-1 font-semibold text-amber-800"}, [cautionsTitle]), __jacJsx("ul", {"className": "list-disc space-y-1 pl-5 text-amber-900"}, [props.advicePlan.cautions.map(c => {
...
function CacheDetailPage() {
  ...
  return __jacJsx("div", {"className": "space-y-4"}, [__jacJsx("div", {"className": "flex items-center justify-between gap-3"}, [__jacJsx("div", {}, [__jacJsx("h1", {"className": "text-xl font-semibold text-emerald-700"}, ["Advice cache detail"]), __jacJsx("p", {"className": "mt-1 text-slate-500"}, ["Inspect a single advice cache entry, its session, and full plan."])]), __jacJsx("button", {"className": " rounded-full border border-emerald-200 px-4 py-1.5 font-medium text-emerald-700 hover:bg-emerald-50 hover:border-emerald-300 transition", "onClick": handleBackClick}, ["← Back to manage"])]), loading && __jacJsx("div", {"className": "rounded-2xl border border-slate-200 bg-white p-4 text-slate-500"}, ["Loading cache details…"]), !loading && error && __jacJsx("div", {"className": "rounded-2xl border border-red-200 bg-red-50 p-4 text-red-700"}, [error]), !loading && !error && cache && __jacJsx("div", {"className": "space-y-4"}, [__jacJsx("div", {"className": "rounded-2xl border border-emerald-100 bg-white p-4 text-slate-700 shadow-sm"}, [__jacJsx("div", {"className": "grid gap-3 md:grid-cols-2"}, [__jacJsx("div", {}, [__jacJsx("p", {"className": "uppercase tracking-wide text-emerald-700"}, ["Crop"]), __jacJsx("p", {"className": "mt-1 font-medium text-slate-900"}, [crop || "\u2014"])]), __jacJsx("div", {}, [__jacJsx("p", {"className": "uppercase tracking-wide text-emerald-700"}, ["Region"]), __jacJsx("p", {"className": "mt-1 font-medium text-slate-900"}, [region || "\u2014"])]), __jacJsx("div", {}, [__jacJsx("p", {"className": "uppercase tracking-wide text-emerald-700"}, ["Language"]), __jacJsx("p", {"className": "mt-1 font-medium text-slate-900"}, [lang || "\u2014"])])]), __jacJsx("div", {"className": "mt-3 flex flex-wrap gap-4 text-slate-600"}, [__jacJsx("span", {}, [__jacJsx("span", {"className": "font-semibold text-emerald-700"}, ["Created:"]), " ", created_at || "\u2014"]), __jacJsx("span", {}, [__jacJsx("span", {"className": "font-semibold text-emerald-700"}, ["Last used:"]), " ", last_used_at || "\u2014"]), __jacJsx("span", {}, [__jacJsx("span", {"className": "font-semibold text-emerald-700"}, ["Usage count:"]), " ", usage_count])])]), __jacJsx("div", {"className": "flex flex-col gap-4 md:flex-row"}, [__jacJsx("div", {"className": "flex-1 rounded-2xl border border-emerald-100 bg-white p-4 text-slate-800 shadow-sm"}, [__jacJsx("div", {"className": "space-y-3"}, [__jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1 font-semibold uppercase tracking-wide text-emerald-700"}, ["Overview"]), __jacJsx("p", {"className": "leading-relaxed"}, [advice.overview || "\u2014"])]), advice.steps && advice.steps.length > 0 && __jacJsx("div", {}, [__jacJsx("p", {"className": "mb-1 font-semibold uppercase tracking-wide text-emerald-700"}, ["Steps"]), __jacJsx("ol", {"className": "space-y-1 pl-5"}, [advice.steps.map((step, idx) => {
    return __jacJsx("li", {"key": idx}, [step]);
  })])])])]), advice.cautions && advice.cautions.length > 0 && __jacJsx("div", {"className": "flex-1 rounded-xl border border-amber-100 bg-amber-50 p-3"}, [__jacJsx("p", {"className": "mb-1 font-semibold uppercase tracking-wide text-amber-800"}, ["Cautions"]), __jacJsx("ul", {"className": "list-disc space-y-1 pl-5 text-amber-900"}, [advice.cautions.map((c, idx) => {
    return __jacJsx("li", {"key": idx}, [c]);
  })])])])])]);
}
function TopNav() {
